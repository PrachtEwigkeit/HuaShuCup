...
|---|---|---:|---:|---:|---:|
| 2 | n100 | 454.341446 | 454.341446 × 454.341446 | 239563.598 | 0.15 |
| 2 | n200 | 449.500167 | 449 × 448 | 443616.500 | 0.15 |
| 2 | n300 | 560.486842 | 560.486842 × 560.486842 | 626129.763 | 0.15 |
| 3 | n100 | 436 | 436 × 436 | 249438.500 | 0.05902474 |
| 3 | n200 | 433 | 433 × 433 | 457008.000 | 0.06712162 |
| 3 | n300 | 538 | 538 × 538 | 658145.500 | 0.05957462 |

正式结果已经过模块数量、轮廓边界和两两不重叠验证。详细指标以各结果目录
中的 `summary.json` 为准。Terminal 仅参与 HPWL，不参与面积、重叠或轮廓约束。
问题 3 当前结果未命中面积解析下界，因此属于给定搜索预算下的启发式最小值。
